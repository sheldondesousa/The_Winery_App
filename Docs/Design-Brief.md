...
- The empty state uses a transparent circular illustration containing a glass of red wine and grapes on a warm red fill; no invitation text is shown. The input placeholder reads "Ask me about wine" at 17sp italic.
