...
- The empty state uses a transparent wine-glass illustration centered inside a borderless, softly filled wine-tinted circle; no invitation text is shown. The input placeholder reads "Ask me about wine" at 17sp italic.
